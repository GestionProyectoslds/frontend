    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          "http://localhost:5153/api/Statistics",
          config
        );
  ...
  return (
    <div>
      ...
      <div className="ml-20 mr-20">
        ...
        <h1 className="text-base text-gray-400 sm:text-lg ml-5 mt-2 font-bold">
          Dashboard
        </h1>
        <div className=" mx-auto flex flex-wrap">
          <div className="w-full md:w-1/4 p-4">
            <div className="bg-white border rounded-md shadow-md p-4">
              ...
              <form className="flex justify-between mt-5">
                <h2 className="text-lg font-bold mb-2 text-gray-950 sm:text-lg">
                  Proyectos
                </h2>
                <h2 className="text-xl font-bold mb-2 text-gray-950 mr-10 sm:text-lg">
          ...
          <div className="w-full md:w-1/4 p-4">
            <div className="bg-white border rounded-md shadow-md p-4">
              ...
              <form className="flex justify-between mt-5">
                ...
                <h2 className="text-xl font-bold mb-2 text-gray-950 mr-9 sm:text-lg">
                  {data.normalUsersCount}
                </h2>
              </form>
            </div>
          </div>
          <div className="w-full md:w-1/4 p-4">
            <div className="bg-white border rounded-md shadow-md p-4">
              ...
              <form className="flex justify-between  mt-5">
                <h2 className="text-lg font-bold mb-2 stext-gray-950 sm:text-lg">
                  Tareas
                </h2>
                <h2 className="text-xl font-bold mb-2 text-gray-950 mr-9 sm:text-lg">
        ...
        <div className="mx-auto flex flex-row">
          <div className="w-full p-4">
            <div className="bg-white border rounded-md p-4">
              <h2 className="text-xl font-bold mb-2 text-gray-950 sm:text-lg">
